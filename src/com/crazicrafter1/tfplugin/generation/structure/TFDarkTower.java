...
public class TFDarkTower extends TFBossStructure {
    ...
    public TFDarkTower(int x, int z) {
        super(TFBoss.Type.URGHAST, x, z);
    }
    ...
    public void generate() {
        ...
        //NMSHandler.setBlock(Block.getCombinedId(Blocks.DARK_OAK_LOG.getBlockData()), TFGlobal.TFWORLD, x, TFGlobal.TFWORLD.getHighestBlockYAt(x, z), z);
