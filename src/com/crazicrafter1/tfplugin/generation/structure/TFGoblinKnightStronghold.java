...
public class TFGoblinKnightStronghold extends TFBossStructure {

    public TFGoblinKnightStronghold(int x, int z) {
        super(TFBoss.Type.KNIGHTPHANTOM, x, z);
    }
    ...
    public void generate() {
        ...
        //NMSHandler.setBlock(Block.getCombinedId(Blocks.BRICKS.getBlockData()), TFGlobal.TFWORLD, x, TFGlobal.TFWORLD.getHighestBlockYAt(x, z), z);
