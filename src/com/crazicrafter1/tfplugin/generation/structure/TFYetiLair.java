...
public class TFYetiLair extends TFBossStructure {

    public TFYetiLair(int x, int z) {
        super(TFBoss.Type.ALPHAYETI, x, z);
    }
    ...
    public void generate() {
        ...
        //NMSHandler.setBlock(Block.getCombinedId(Blocks.SNOW_BLOCK.getBlockData()), TFGlobal.TFWORLD, x, TFGlobal.TFWORLD.getHighestBlockYAt(x, z), z);
